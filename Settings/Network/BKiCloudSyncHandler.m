...
NSString *BKiCloudContainerIdentifier = @"iCloud.kr.docs.blinkshell";
...
//  CKDatabase *database = [[CKContainer containerWithIdentifier:@"iCloud.kr.docs.blinkshell"]privateCloudDatabase];
